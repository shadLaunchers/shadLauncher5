#!/bin/bash
# SPDX-FileCopyrightText: 2026 shadLauncher5 Emulator Project
...
export OUTPUT="shadLauncher5.AppImage"
...
./linuxdeploy-x86_64.AppImage \
    --appdir AppDir \
    -d "$GITHUB_WORKSPACE/dist/net.shadps4.shadLauncher5.desktop" \
    -e "$GITHUB_WORKSPACE/build/shadLauncher5" \
    -i "$GITHUB_WORKSPACE/src/images/shadLauncher5.png" \
    --plugin qt
